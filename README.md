...
**Объект исследований:** автоматизированные системы обмена сообщениями, интегрированные в средства телекоммуникационной связи.
...
**Точка зрения:** Руковододитель информационно - новостного агентства.
